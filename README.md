...
These steps are for installing in Ubuntu 16.04 but it should be compatible and with other Ubuntu versions. Open a terminal and follow the steps for the installation.
...
Keep in mind that everytime you run ganache-cli you have to migrate the smart contracts again and copy paste the address of Market smart contract to Market.js file.
...
- test five: Ensure that store owners are able to manage their storefronts and they can add new items. We must ensure that only a store owner can manage his own stores
